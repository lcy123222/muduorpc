...
class GetFriendListsResponse :
 ...
 public:
  ...
  enum : int {
    kFroemdListFieldNumber = 2,
    kResultFieldNumber = 1,
  };
  // repeated .fixbug.User froemd_list = 2;
  int froemd_list_size() const;
  private:
  int _internal_froemd_list_size() const;
  public:
  void clear_froemd_list();
  ::fixbug::User* mutable_froemd_list(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >*
      mutable_froemd_list();
  private:
  const ::fixbug::User& _internal_froemd_list(int index) const;
  ::fixbug::User* _internal_add_froemd_list();
  public:
  const ::fixbug::User& froemd_list(int index) const;
  ::fixbug::User* add_froemd_list();
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User > froemd_list_;
  ::fixbug::ResultCode* result_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_test_2eproto;
};
...
class UserSerbiceRpc_Stub;

class UserSerbiceRpc : public ::PROTOBUF_NAMESPACE_ID::Service {
 protected:
  // This class should be treated as an abstract interface.
  inline UserSerbiceRpc() {};
 public:
  virtual ~UserSerbiceRpc();

  typedef UserSerbiceRpc_Stub Stub;
 ...
 private:
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(UserSerbiceRpc);
};

class UserSerbiceRpc_Stub : public UserSerbiceRpc {
 public:
  UserSerbiceRpc_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel);
  UserSerbiceRpc_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel,
 ...
 private:
  ...
  bool owns_channel_;
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(UserSerbiceRpc_Stub);
};
...
// repeated .fixbug.User froemd_list = 2;
inline int GetFriendListsResponse::_internal_froemd_list_size() const {
  return froemd_list_.size();
}
inline int GetFriendListsResponse::froemd_list_size() const {
  return _internal_froemd_list_size();
}
inline void GetFriendListsResponse::clear_froemd_list() {
  froemd_list_.Clear();
}
inline ::fixbug::User* GetFriendListsResponse::mutable_froemd_list(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListsResponse.froemd_list)
  return froemd_list_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >*
GetFriendListsResponse::mutable_froemd_list() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendListsResponse.froemd_list)
  return &froemd_list_;
}
inline const ::fixbug::User& GetFriendListsResponse::_internal_froemd_list(int index) const {
  return froemd_list_.Get(index);
}
inline const ::fixbug::User& GetFriendListsResponse::froemd_list(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsResponse.froemd_list)
  return _internal_froemd_list(index);
}
inline ::fixbug::User* GetFriendListsResponse::_internal_add_froemd_list() {
  return froemd_list_.Add();
}
inline ::fixbug::User* GetFriendListsResponse::add_froemd_list() {
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListsResponse.froemd_list)
  return _internal_add_froemd_list();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >&
GetFriendListsResponse::froemd_list() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendListsResponse.froemd_list)
  return froemd_list_;
}
