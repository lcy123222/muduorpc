...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListsResponse, froemd_list_),
};
...
const char descriptor_table_protodef_test_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ixbug.ResultCode\022!\n\013froemd_list\030\002 \003(\0132\014."
  "fixbug.User2\227\001\n\016UserSerbiceRpc\0224\n\005Login\022"
...
GetFriendListsResponse::GetFriendListsResponse(const GetFriendListsResponse& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      _internal_metadata_(nullptr),
      froemd_list_(from.froemd_list_) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  if (from._internal_has_result()) {
    result_ = new ::fixbug::ResultCode(*from.result_);
  } else {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(_internal_add_froemd_list(), ptr);
            CHK_(ptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* GetFriendListsResponse::_InternalSerialize(
  ...
  for (unsigned int i = 0,
      n = static_cast<unsigned int>(this->_internal_froemd_list_size()); i < n; i++) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(2, this->_internal_froemd_list(i), target, stream);
  }
...
// @@protoc_insertion_point(message_byte_size_start:fixbug.GetFriendListsResponse)
  ...
  // repeated .fixbug.User froemd_list = 2;
  total_size += 1UL * this->_internal_froemd_list_size();
  for (const auto& msg : this->froemd_list_) {
    total_size +=
...
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.GetFriendListsResponse)
  ...
  froemd_list_.MergeFrom(from.froemd_list_);
  if (from.has_result()) {
    _internal_mutable_result()->::fixbug::ResultCode::MergeFrom(from._internal_result());
  }
}
...
void GetFriendListsResponse::InternalSwap(GetFriendListsResponse* other) {
  using std::swap;
  _internal_metadata_.Swap(&other->_internal_metadata_);
  froemd_list_.InternalSwap(&other->froemd_list_);
  swap(result_, other->result_);
}
...
UserSerbiceRpc::~UserSerbiceRpc() {}

const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* UserSerbiceRpc::descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_test_2eproto);
  return file_level_service_descriptors_test_2eproto[0];
}

const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* UserSerbiceRpc::GetDescriptor() {
  return descriptor();
}

void UserSerbiceRpc::Login(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
...
void UserSerbiceRpc::GetFriendLists(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
...
void UserSerbiceRpc::CallMethod(const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method,
...
const ::PROTOBUF_NAMESPACE_ID::Message& UserSerbiceRpc::GetRequestPrototype(
...
const ::PROTOBUF_NAMESPACE_ID::Message& UserSerbiceRpc::GetResponsePrototype(
    const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method) const {
  GOOGLE_DCHECK_EQ(method->service(), descriptor());
  switch(method->index()) {
    case 0:
...
UserSerbiceRpc_Stub::UserSerbiceRpc_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel)
  : channel_(channel), owns_channel_(false) {}
UserSerbiceRpc_Stub::UserSerbiceRpc_Stub(
...
void UserSerbiceRpc_Stub::Login(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
...
void UserSerbiceRpc_Stub::GetFriendLists(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
